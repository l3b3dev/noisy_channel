function [x_embed,y,y_ref,x_test_embed,y_test_ref,H] = generate_channel_data(opt)
...
options = struct('N',1500,'N_test',500,'chlen',5,...
...
H = [-0.8 0.7 0 0 0]; % linear channel coefficients

f = inline(fun); % fun = 'x+0.25*x.*x+0.11*x.*x.*x'; % non-linearity
